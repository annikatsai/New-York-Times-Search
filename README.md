...
http://imgur.com/wF6IB1s

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

This app required learning and using several new concepts such as RecyclerView, using and styling the ToolBar, how to implement 
filter search using activities and intents, and more JSON and API related topics. Implementing the filter function took a good amount
of time because it involved having to make the filter activity as well as be able to pass values through, as well as persisting 
the filter choices in subsequent searches. 
